...
const bitolas = [  
    ...
    [4, 28, 'Chuveiros até 5500W'],  
    [6, 36, 'Chuveiros até 7700W'],  
    [10, 50, 'Alimentadores, ar condicionado'],  
...
document.getElementById("resultadoOrcamento").innerHTML =
  Corrente: ${corrente.toFixed(2)} A<br>   Bitola: ${bitola}<br>   Disjuntor: ${disjuntor}<br>   Cabo necessário: ${cabo.toFixed(1)} m<br><br>   <b>Mão de obra sugerida: R$ ${maoObra.toFixed(2)}</b>  ;
